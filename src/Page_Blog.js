    ...
    const blogEntries = [
        {
            ...
            details: 'This table provides a summary of the current Top 25 players in the Longhorn Scoreboard. The rankings include historical card prices, player career statistics, and Google Trends interest. Key players across Football, Baseball, and Basketball are included.',
        ...
        },
        {
            ...
            details: 'Our overall Scoreboard combines player career statistics, historical card prices, and Google Trends sentiment to calculate a Composite Rank for each player. Also provided is the current price trend and percentages from different price levels.',
        ...
        },
        {
            ...
            details: 'This heatmap shows rankings over time for key MLB players using Google Trends to measure interest and popularity.',
        ...
        },
        {
            ...
            details: 'This heatmap shows rankings over time for key NFL players (plus a few 2024 Draft Picks) using Google Trends to measure interest and popularity.',
        ...
        },
        {
            ...
            details: 'This heatmap shows rankings over time for key NBA players using Google Trends to measure interest and popularity.',
        ...
        },
        {
            ...
            details: 'Google Trends for the Top 10 NFL Draft Picks in 2024. JJ McCarthy is head of the pack in terms of interest along with Caleb Williams.',
        ...
        },
        {
            ...
            details: 'Google Trends over the past 5 years for a few key NBA players. Can see how Anthony Edwards has soared in popularity. Plotting his Google trend versus his card prices helps visualize the associated spike in card values.',
        ...
        },
        {
            ...
            details: 'The NFL Wide Receiver/Tight End rankings below are based on Career statistics across numerous categories. The Overall Score is a proprietary formula that applies different weightings to a variety of key statistics.',
        ...
        },
        {
            ...
            details: 'The NFL Quarterback rankings below are based on Career statistics across numerous categories. The Overall Score is a proprietary formula that applies different weightings to a variety of key statistics.',
        ...
        },
        {
            ...
            details: 'Now available on our website are comparisons for player scores versus how far their current price level is from their all-time high price level.',
        ...
        },
        {
            ...
            details: 'This list provides the top 20 sales for football, baseball, and basketball cards within a price range of $100 to $1000. One of the most heavily traded segments of the market. The 2018 Panini Prizm #280 Luka Doncic rookie card (PSA 10) sold for as high as $2000 in 2021, and has been in the $200-300 range for the past year.',
