        ...
        <div className="page-blog">
            ...
            <div className="blog-table-container">
                <table className="blog-table">
                    ...
                    <tbody>
                        <tr>
                            <td className="top-align" data-label="Date">05/31/24</td>
                            <td className="top-align" data-label="Title">Player Scoreboard - Top 25</td>
                            <td className="top-align" data-label="Summary">The Longhorns Cards Player Scoreboard Top 25 Players by Composite Rank</td>
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/26/24</td>
                            <td className="top-align" data-label="Title">Player Scoreboard</td>
                            <td className="top-align" data-label="Summary">The Longhorn Cards Player Scoreboard ranks Football, Basketball, and Baseball players using historical card sale prices, player career statistics, and Google Trends interest.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/23/24</td>
                            <td className="top-align" data-label="Title">Longhorn Cards Player Scoreboard May 2024</td>
                            <td className="top-align" data-label="Summary">Our overall Scoreboard combines player career statistics, historical card prices, and Google Trends sentiment to calculate a Composite Rank for each player.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/22/24</td>
                            <td className="top-align" data-label="Title">MLB Google Trends Rankings Heatmap</td>
                            <td className="top-align" data-label="Summary">This heatmap shows rankings over time for key MLB players using Google Trends to measure interest and popularity.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/21/24</td>
                            <td className="top-align" data-label="Title">NFL Google Trends Rankings Heatmap</td>
                            <td className="top-align" data-label="Summary">This heatmap shows rankings over time for key NFL players (plus a few 2024 Draft Picks) using Google Trends to measure interest and popularity.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/20/24</td>
                            <td className="top-align" data-label="Title">NBA Google Trends Rankings Heatmap</td>
                            <td className="top-align" data-label="Summary">This heatmap shows rankings over time for key NBA players using Google Trends to measure interest and popularity.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/19/24</td>
                            <td className="top-align" data-label="Title">NFL Top 10 Draft Picks - Google Trends</td>
                            <td className="top-align" data-label="Summary">Google Trends for the Top 10 NFL Draft Picks in 2024.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/18/24</td>
                            <td className="top-align" data-label="Title">Google Trends</td>
                            <td className="top-align" data-label="Summary">Google Trends over the past 5 years for a few key NBA players.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/17/24</td>
                            <td className="top-align" data-label="Title">NFL Wide Receiver & Tight End Rankings</td>
                            <td className="top-align" data-label="Summary">The NFL Wide Receiver/Tight End rankings below are based on Career statistics across numerous categories.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/16/24</td>
                            <td className="top-align" data-label="Title">NFL Quarterback Rankings</td>
                            <td className="top-align" data-label="Summary">The NFL Quarterback rankings below are based on Career statistics across numerous categories.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/14/24</td>
                            <td className="top-align" data-label="Title">Player Scatterplots</td>
                            <td className="top-align" data-label="Summary">Now available on our website are comparisons for player scores versus how far their current price level is from their all-time high price level.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/13/24</td>
                            <td className="top-align" data-label="Title">Sports Player Performance - May 2024</td>
                            <td className="top-align" data-label="Summary">This is our inaugural report for Sports Player Index Performance for key players across baseball, basketball, and football relative to their peers.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/12/24</td>
                            <td className="top-align" data-label="Title">Sports Player Screen - May 2024</td>
                            <td className="top-align" data-label="Summary">This is our inaugural screen of what we consider 'blue chip' players that have available card price/index data to analyze.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/11/24</td>
                            <td className="top-align" data-label="Title">NBA Player Index Performance Comparison</td>
                            <td className="top-align" data-label="Summary">Highlighting 4 players in the NBA playoffs this year to compare their performance over the past year based on card prices: Anthony Edwards, Jalen Brunson, Nikola Jokic, and Jayson Tatum.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/10/24</td>
                            <td className="top-align" data-label="Title">Recent Card Sales (May 2024)</td>
                            <td className="top-align" data-label="Summary">This list provides the top 20 sales for football, baseball, and basketball cards within a price range of $100 to $1000.</td>
                            <td className="top-align" data-label="Details">
                        ...
                        <tr>
                            <td className="top-align" data-label="Date">05/09/24</td>
                            <td className="top-align" data-label="Title">Sports Card Market Update April 2024</td>
                            <td className="top-align" data-label="Summary">The broad sports card index is up double-digits YTD, but baseball, football, and basketball indexes are still consolidating. The market is still a ways off all-time-highs set in 2021 but has realized strong long-term returns. See this month's update for more detail.</td>
                            <td className="top-align" data-label="Details">
