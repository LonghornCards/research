...
const Page_GradedCards = () => {
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then((response) => {
                // Filter products that contain the "graded" tag
                const gradedProducts = response.data.filter(product =>
                    product.Tags && product.Tags.includes('graded')
                );
    ...
    return (
        <div className="products-page">
            <h1 className="products-title">Graded Cards: Please Check Back & Subscribe for New Product Updates</h1>
...
export default Page_GradedCards;
