...
import PageInventory from './PageInventory';  // Import the PageInventory component
import './App.css';
    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route path="/pageinventory" element={<PageInventory />} />  {/* Add the new route for PageInventory */}
            </Routes>
        </Router>
    );
};
