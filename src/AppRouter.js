...
import Page_RawCards from './Page_RawCards';
import Page_Returns from './Page_Returns';
    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route path="/page_rawcards" element={<Page_RawCards />} />
                <Route path="/page_returns" element={<Page_Returns />} />
